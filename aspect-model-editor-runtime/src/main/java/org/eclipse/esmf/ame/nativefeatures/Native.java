...
import org.eclipse.esmf.ame.substitution.IsLinux;
...
public class Native {
   ...
   public Native registerEverythingForReflection() {
      return registerClassForReflection().registerAllFieldsForReflection().registerAllConstructorsForReflection()
   ...
   public Native registerConstructorForReflection( @Nonnull final Class<?>... args ) {
      try {
         ...
         throw new RuntimeException( "Could not find constructor in " + clazz + " with args " + Arrays.stream( args ).map( Class::toString )
   ...
   public Native registerMethodForReflection( final String name, @Nonnull final Class<?>... args ) {
      try {
         ...
         throw new RuntimeException(
               "Could not find method " + name + " in " + clazz + " with args " + Arrays.stream( args ).map( Class::toString )
                     .collect( Collectors.joining( ",", "[", "]" ) ) );
      }
      return this;
   }
   ...
   public Native registerEverythingForJni() {
      return registerClassForJni().registerAllFieldsForJni().registerAllConstructorsForJni().registerAllMethodsForJni();
   }
