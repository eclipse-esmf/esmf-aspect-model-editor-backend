...
public interface ModelResolverStrategy {
    ...
    *
    * @return A list of {@link NamespaceFileContent} containing information about each imported Aspect Model.
    */
   List<NamespaceFileContent> getImportedNamespaceFileContent();
