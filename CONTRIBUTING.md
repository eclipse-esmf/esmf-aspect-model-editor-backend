# Contribution Guideline ESMF Aspect Model Editor backend

Thank you for your interest in contributing to the ESMF Aspect Model Editor backend. Use this repository to contribute
to
the Aspect Model Editor backend as easy and transparent as possible, whether it is:
...
The ESMF Aspect Model Editor backend is developed in the context of the [Eclipse Semantic Modeling
...
The ESMF Aspect Model Editor backend is written in the Java Programming Language. Please have a look into our [Code
